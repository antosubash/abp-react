        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              The menu item you are looking for doesn&apos;t exist.
            </p>
            <Button onClick={() => router.push('/admin/cms/menus')} className="mt-4">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                {formErrors.displayName && (
                  <p className="text-sm text-red-500">
                    {Array.isArray(formErrors.displayName)
                      ? formErrors.displayName.join(', ')
                      : formErrors.displayName}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Leave empty if linking to a page</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Icon name (optional)</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  defaultValue={watch('target') || '_self'}
                >
                  <SelectTrigger>
                ...
                {formErrors.target && (
                  <p className="text-sm text-red-500">
                    {Array.isArray(formErrors.target)
                      ? formErrors.target.join(', ')
                      : formErrors.target}
                  </p>
                )}
              </div>
                ...
                {formErrors.cssClass && (
                  <p className="text-sm text-red-500">
                    {Array.isArray(formErrors.cssClass)
                      ? formErrors.cssClass.join(', ')
                      : formErrors.cssClass}
                  </p>
                )}
                <p className="text-sm text-muted-foreground">Additional CSS classes</p>
              </div>
            </div>
              ...
              {formErrors.elementId && (
                <p className="text-sm text-red-500">
                  {Array.isArray(formErrors.elementId)
                    ? formErrors.elementId.join(', ')
                    : formErrors.elementId}
                </p>
              )}
              <p className="text-sm text-muted-foreground">HTML element ID (optional)</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              {formErrors.requiredPermissionName && (
                <p className="text-sm text-red-500">
                  {Array.isArray(formErrors.requiredPermissionName)
                    ? formErrors.requiredPermissionName.join(', ')
                    : formErrors.requiredPermissionName}
                </p>
              )}
