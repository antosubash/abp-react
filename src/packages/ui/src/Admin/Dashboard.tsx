    ...
    <div>
      ...
      <div className="flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row">
        <div className="w-full md:w-6/12">
          <div className="shadow-lg w-full  relative overflow-hidden">
            <a href="#" className="w-full h-full block">
              <div className="flex items-center justify-between px-4 py-6 space-x-4">
                <div className="flex items-center">
                  ...
                  <p className="text-sm  ml-2 font-semibold border-b border-gray-200">
                    Level 2 Ambassador
                  </p>
                </div>
                <div className="border-b border-gray-200 mt-6 md:mt-0  font-bold text-xl">
                  $44,453.39
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
        <div className="w-full">
          <div className="shadow-lg px-4 py-6 w-full  relative">
            <p className="text-sm w-max  font-semibold border-b border-gray-200">
              Project Reffered
            </p>
